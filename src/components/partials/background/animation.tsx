...
const AnimatedBackground: React.FC = () => {
  return (
    <>
      {/* Animated Background */}
      <div className="absolute inset-0 overflow-hidden bg-gradient-to-br from-rose-400 via-orange-300 to-amber-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors">
        ...
        <div className="absolute top-1/4 left-1/4 w-40 h-40 bg-gradient-to-r from-pink-300/40 to-rose-400/40 dark:from-pink-900/20 dark:to-rose-800/20 rounded-full mix-blend-soft-light filter blur-2xl animate-slow-pulse pointer-events-none"></div>
        <div className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-gradient-to-r from-orange-200/40 to-amber-300/40 dark:from-orange-900/20 dark:to-amber-800/20 rounded-full mix-blend-soft-light filter blur-2xl animate-slow-pulse delay-1000 pointer-events-none"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-36 h-36 bg-gradient-to-r from-yellow-200/30 to-orange-300/30 dark:from-yellow-900/10 dark:to-orange-800/10 rounded-full mix-blend-soft-light filter blur-2xl animate-slow-pulse delay-500 pointer-events-none"></div>
